        ...
        <div className={style.contenedor}>
          ...
          <form className={style.form} action="" onSubmit={handleSubmit}>
            <div className={style.group}>
              <label className={style.nombre} htmlFor="name">
                Nombre:
              </label>
              <input
            ...
            <div className={style.group}>
              <label className={style.descripcion} htmlFor="descripcion">
                Observaciones:
              </label>
              <textarea
                className={style.inputDescripcion}
                name="descripcion"
                id="descripcion"
            ...
            <div className={style.group}>
              <label className={style.tipo} htmlFor="type">
                Tipo:
              </label>
            ...
            <div className={style.group}>
              <label className={style.proveedor} htmlFor="prov">
                Proveedor:
              </label>
            ...
            <div className={style.grupoCorto}>
              <div className={style.group}>
                <label className={style.precio} htmlFor="price">
                  Precio:
                </label>
                <input
              ...
              <div className={style.group}>
                <label className={style.ganancia} htmlFor="profit">
                  % Ganancia:
                </label>
                <input
                  className={style.inputGanancia}
                  type="number"
                  id="profit"
                  name="profit"
                  value={input.ganance}
                ...
                />
                {errors.ganance ? (
                  <span style={{ color: "red" }}>{errors.ganance}</span>
                ) : (
                  ""
                )}
              </div>
